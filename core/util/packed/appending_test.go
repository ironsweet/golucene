...
var data2 = []int64{
	6185616547450357520, 8302353148434182964, 1859619245181754263,
	4108041447097698316, 4259189316260984393, 7496607144297289052,
	627396136903120621, 2810584700330483226, 1727349277841990154,
	941501814177403893,
}

func TestAppendingLongBuffer(t *testing.T) {
	arr := make([]int64, rand.Intn(100000)+1)
