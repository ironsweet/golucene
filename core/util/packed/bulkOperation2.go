...
func (op *BulkOperationPacked2) decode(blocks []int64, values []int64, iterations int) {
...
func (op *BulkOperationPacked2) decodeByteToint64(blocks []byte, values []int64, iterations int) {
	blocksOffset, valuesOffset := 0, 0
