...
func (op *BulkOperationPacked5) decodeByteToInt(blocks []byte, values []int32, iterations int) {
	...
	for i := 0; i < iterations; i ++ {
		...
		blocksOffset++
		values[valuesOffset] = int32( byte(uint8(byte0) >> 3))
		valuesOffset++
		byte1 := blocks[blocksOffset]
		blocksOffset++
		values[valuesOffset] = int32(((byte0 & 7) << 2) | byte(uint8(byte1) >> 6))
		valuesOffset++
		values[valuesOffset] = int32( byte(uint8(byte1 >> 1)) & 31)
		valuesOffset++
		byte2 := blocks[blocksOffset]
		blocksOffset++
		values[valuesOffset] = int32(((byte1 & 1) << 4) | byte(uint8(byte2) >> 4))
		valuesOffset++
		byte3 := blocks[blocksOffset]
		blocksOffset++
		values[valuesOffset] = int32(((byte2 & 15) << 1) | byte(uint8(byte3) >> 7))
		valuesOffset++
		values[valuesOffset] = int32( byte(uint8(byte3 >> 2)) & 31)
		valuesOffset++
		byte4 := blocks[blocksOffset]
		blocksOffset++
		values[valuesOffset] = int32(((byte3 & 3) << 3) | byte(uint8(byte4) >> 5))
		valuesOffset++
...
func (op *BulkOperationPacked5) decodeByteToLong(blocks []byte, values []int64, iterations int) {
	...
	for i := 0; i < iterations; i ++ {
		byte0 := blocks[blocksOffset]
		blocksOffset++
		values[valuesOffset] = int64( byte(uint8(byte0) >> 3))
		valuesOffset++
		byte1 := blocks[blocksOffset]
		blocksOffset++
		values[valuesOffset] = int64(((byte0 & 7) << 2) | byte(uint8(byte1) >> 6))
		valuesOffset++
		values[valuesOffset] = int64( byte(uint8(byte1 >> 1)) & 31)
		valuesOffset++
		byte2 := blocks[blocksOffset]
		blocksOffset++
		values[valuesOffset] = int64(((byte1 & 1) << 4) | byte(uint8(byte2) >> 4))
		valuesOffset++
		byte3 := blocks[blocksOffset]
		blocksOffset++
		values[valuesOffset] = int64(((byte2 & 15) << 1) | byte(uint8(byte3) >> 7))
		valuesOffset++
		values[valuesOffset] = int64( byte(uint8(byte3 >> 2)) & 31)
		valuesOffset++
		byte4 := blocks[blocksOffset]
		blocksOffset++
		values[valuesOffset] = int64(((byte3 & 3) << 3) | byte(uint8(byte4) >> 5))
		valuesOffset++
