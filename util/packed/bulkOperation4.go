...
func (op *BulkOperationPacked4) decode(blocks []int64, values []int64, iterations int) {
...
func (op *BulkOperationPacked4) decodeByteToint64(blocks []byte, values []int64, iterations int) {
	blocksOffset, valuesOffset := 0, 0
